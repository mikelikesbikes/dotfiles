...
export STORM_BIN="$HOME/projects/storm/storm-0.7.4/bin"

export PATH="$HOME/bin:$HOMEBREW_PATHS:/opt/local/bin:/opt/local/sbin:/opt/nginx/sbin/:$STORM_BIN:$JAVA_HOME/bin:/opt/subversion/bin:$PATH"
export CDPATH=.
